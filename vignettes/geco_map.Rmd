...
ggmap <- ggplot() +
  ...
  geom_raster(data = df, aes(x = lon, y = lat, fill = layercut, color = layercut), show.legend = FALSE) +
...
- would be nice to clip by coastline and give the ocean a different color
